...
import MoneyOne from '../Emoji-Icons/Money/MoneyOne.jsx'
import MoneyTwo from '../Emoji-Icons/Money/MoneyTwo.jsx'
        ...
        <CardBody>
          <Row className="clearfix pb-3">
            <Col sm='12' className="d-flex align-self-center justify-content-center">
              <CardTitle className="align-self-center">I'm willing to spend{this.props.CardTitle}</CardTitle>
            </Col>
          </Row>
          <Row>
            <Col sm='6' className="py-1 d-flex align-items-center justify-content-center ProfileButton">
              {/* <ProfileButton /> */}
              <MoneyOne className="emojis"/>
            </Col>
